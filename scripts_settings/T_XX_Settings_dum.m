...
pulse  = [0,0,0];
multisin  = [1,0,0];
inputid = per+ramp+step+pulse+multisin;

inputshare = 1;
inputtime = 100;
inputamp = 500;%0:100:1000;
Tper    = 20;
pulselength = 200;
sinfreq = 1:2:19;%[3,7,13];
...
% SynConMat = [0.5 -1 0; % weights RS-FS-LTS
%              0.5 -1 0;
%              0  0  0];
